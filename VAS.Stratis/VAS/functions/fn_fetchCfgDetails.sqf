...
*/
params [["_entity","",[""]],"_cfg","_ret","_type","_acc_u","_acc_p","_acc_o","_slotclasses","_acc_m","_scope","_displayName","_picture","_config","_itemInfo","_muzzles","_magazines","_desc","_base","_AGMItem"];
_type = -1;
_acc_p = [];
_acc_o = [];
_acc_m = [];
...
_ret = [];
if!(typeName _cfg isEqualTo "STRING") exitWith {[]}; //Not a config
