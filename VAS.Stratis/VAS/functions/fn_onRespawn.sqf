...
if(VAS_slot isEqualTo -1) exitWith {hint localize "STR_VAS_Prompt_onRespawnFail"; if(!isNil "VAS_Respawn_Handler") then {player removeEventHandler["Respawn",VAS_Respawn_Handler]; VAS_Respawn_Handler = nil;}};
